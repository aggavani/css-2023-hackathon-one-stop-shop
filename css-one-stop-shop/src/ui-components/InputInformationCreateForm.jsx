...
export default function InputInformationCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new InputInformation(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "InputInformationCreateForm")}
      {...rest}
    >
      <TextField
        label="Scope"
