  ...
  return (
    ...
    >
        ...
        >
          ...
          >
            <MyIcon
              ...
              padding="0px 0px 0px 0px"
              type="arrow-right"
              {...getOverrideProps(overrides, "MyIcon37783386")}
            ></MyIcon>
            <Text
              fontFamily="Inter"
              fontSize="16px"
          ...
          <Flex
            ...
            position="relative"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Share37783388")}
          >
            <Text
              fontFamily="Inter"
              fontSize="16px"
              ...
              whiteSpace="pre-wrap"
              children="Share"
              {...getOverrideProps(overrides, "Share37783389")}
            ></Text>
            <MyIcon
              width="24px"
              height="24px"
              ...
              {...getOverrideProps(overrides, "MyIcon37783390")}
            ></MyIcon>
            <MyIcon
              width="24px"
              height="24px"
              ...
              padding="0px 0px 0px 0px"
              type="share"
              {...getOverrideProps(overrides, "MyIcon37783391")}
            ></MyIcon>
            <MyIcon
              width="24px"
              height="24px"
              ...
              padding="0px 0px 0px 0px"
              type="more_vert"
              {...getOverrideProps(overrides, "MyIcon37783392")}
            ></MyIcon>
          </Flex>
        </Flex>
        <Image
      ...
      <Flex
        ...
        position="relative"
        padding="0px 0px 0px 0px"
        {...getOverrideProps(overrides, "Read more37783394")}
      >
        <MyIcon
          width="24px"
          height="24px"
          ...
          padding="0px 0px 0px 0px"
          type="arrow-right"
          {...getOverrideProps(overrides, "MyIcon37783395")}
        ></MyIcon>
        <Text
          fontFamily="Inter"
          fontSize="16px"
          ...
          whiteSpace="pre-wrap"
          children="Read more"
          {...getOverrideProps(overrides, "Read more37783396")}
        ></Text>
      </Flex>
    </Flex>
  );
